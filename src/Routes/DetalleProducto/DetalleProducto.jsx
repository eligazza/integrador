...
import { tours } from "../../dataTest/data";
import { Select, SelectItem } from "@nextui-org/react";

const DetalleProducto = () => {
  const favoriteTours = [...tours];
  const {id}= useParams() // Con esta linea se obtiene el id de qla 
...
console.log(id)
  ...
  useEffect(() => {
    //setLoading(false);
    //index = parseInt(window.location.href.slice(-2).replace(/[^a-zA-Z0-9 ]/g, '')); <= Esto lo comentamos y usamos el params
...
import { tours as guide } from "../../dataTest/data";
