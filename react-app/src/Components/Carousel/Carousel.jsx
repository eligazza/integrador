    ...
    <div className="overflow-visible flex items-center space-x-2 text-base mx-auto py-10 justify-center">
      <div className="flex justify-center pl-[20rem]">
        ...
        <div className="flex-initial">
          ...
          >
            <img
              src="/images/detalles/angulo-izquierdo1.svg"
              alt="Back late"
        ...
        <div className="flex-initial">
            <img key={currentIndex} src={images[(currentIndex)%4]} className="w-[10rem] rounded-3xl m-4 bg-gradient-to-r from-inherit" />            
        </div>

        <div className="flex-initial">
            <img key={currentIndex} src={images[(currentIndex+1)%4]} className="w-[15rem] rounded-3xl m-4 " />
        </div>

        <div className="flex-initial">
            <img key={currentIndex} src={images[(currentIndex+2)%4]} className="w-[10rem] rounded-3xl m-4 bg-gradient-to-r from-inherit" />
        </div>

        
        <div className="flex-initial" onClick={handleNext}>
          <img
            src="/images/detalles/angulo-izquierdo2.svg"
            alt="Back late"
            className="justify-item-center flex text-94 w-[4rem] pt-[6rem]"
          />
        </div>
